...
<div class="container">
    ...
    <script>
        ...
        // Init , static map
        var image = L.imageOverlay('../img/figure.png', bounds).addTo(mymap);

        var size = zoneTags.length;
        for(var x = 0 ; x < size ; x++){
            var polygon = L.polygon(zoneTags[x]).addTo(mymap);
            polygon.bindPopup(zoneTags[x].toString());
        }
